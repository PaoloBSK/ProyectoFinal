        ...
        <Container>
          <Row>
            <Col lg='9'>
              {
                cartItems.length===0 ? (
                <h2 className='fs-4 text-center'>No se a añadido algun producto al carrito</h2> 
                ):(
            ...
            <Col lg='3'>
              ...
              <div>
                ...
                <button className="buy_btn w-100 mt-3"> <Link to='/shop'>Continuar Comprando</Link></button>
